...
export function Paso4ConfirmarCita({ datos }) {
  ...
  return (
    <div className="p-6">
      <h3 className="text-xl font-bold text-gray-900 mb-2">Confirma los datos de la cita</h3>
      <p className="text-gray-600 mb-6">Revisa todo antes de guardar</p>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-gray-900">{datos.cliente?.nombre}</p>
        ...
        <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
          ...
          <div>
            ...
            <p className="text-lg font-bold text-gray-900">{razonInfo?.label || datos.razon}</p>
        ...
        {datos.id_pedido && (
          <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-gray-900">#{String(datos.id_pedido).slice(-4)}</p>
            </div>
          </div>
        )}
